...
export class FlowBox extends Component {
    ...
    set alignContent(value: 'flex-start' | 'flex-end' | 'center' | 'space-between' | 'space-around' | 'stretch') {
        this.element.style.setProperty('--align-content', value);
    }
}
